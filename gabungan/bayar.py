...
def uts():
        ...
        while(jawab == "y") :
            ...
            jum_matkul_uts_bayar.append(input(" ............MATA KULIAH YANG AKAN ANDA BAYAR UTS....... : "))
            bulan_bayar.append(input(".........JUMLAH BULAN BIAYA YANG AKAN ANDA BAYAR......... : "))
            pilih = input("Apakah ingi bayar kas (y/t) ? ")
            if pilih =='y' :
                    bayar_kas = 20000
            else :
                    bayar_kas = 0   
...
def uas():
        ...
        while(jawab == "y") :
            ...
            jum_matkul_uas_bayar.append(input(" ...............MATA KULIAH YANG AKAN ANDA BAYAR UAS........... : "))
            bulan_bayar.append(input(".........................JUMLAH BULAN BIAYA YANG AKAN ANDA BAYAR........ : "))
